...
//             <p>Full Name</p>
//             <input className='border border-zinc-300 roundee w-full p-2 mt-1'
//               type="text"
...
//         <button type='submit' className='bg-primary text-white w-full py-2 rounded-md text-base 'type="submit">{state === 'Sign up' ? 'Create Account' : 'Login'}</button>
//         {
//           state==='Sign up'
