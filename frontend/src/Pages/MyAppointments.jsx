...
//                 <p className="text-xs">{item.docData.address?.line1 || "No address provided"}</p> {/* Optional chaining */}
//                 <p className="text-xs">{item.docData.address?.line2 || "No address provided"}</p> {/* Optional chaining */}
